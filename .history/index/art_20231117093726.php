...
<script>
  function openPage(){
    const amount=document.getElementsById('amount').innerHTML;
    window.location.href='../index/confirmation.html' +encodeURIComponent(amount);

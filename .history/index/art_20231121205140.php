...
<body>
  <div style="color:white;background-color:black;font-size:18px;padding:5px;text-align:center;">HELLO,<?php echo $user_data['user_name'];?></div>
   <div class="art-navbar">
    <div class="art-navbar-head"><img class="paint" src="../images/paint2.png" height="50"><a style="color:white;" href="../index/art-photo.html"><i class="fa-solid fa-arrow-left"></i></a>
   </div>
...
<script>
  function openPage(clickedElement){
    ...
    window.location.href='../index/confirmation1.html?amount=' +encodeURIComponent(amount);

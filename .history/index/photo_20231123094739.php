...
<body>
  <div style="color:white;background-color:black;font-size:18px;padding:5px;text-align:center;">HELLO,<?php echo $user_data['user_name'];?></div>
   <div class="art-navbar">
    <div class="art-navbar-head"></div><span class="paint" style="margin: top 20px;">FEATURED PHOTOS</span><a style="color:white;" href="../index/index.html"><i class="fa-solid fa-arrow-left"></i></a>
   </div>

...
<body>
  <div style="color:white;background-color:black;font-size:20px;padding:5px;">Hello,<?php echo $user_data['user_name'];?></div>
   <div class="art-navbar">
    <p class="featured-art" style="margin:0px;padding:5px;">FEATURED ARTS</p>
   </div>

  ...
  Hello,<?php echo $user_data['user_name'];?>
   ...
   <div class="art-grid" id="grid1">
    <section class="grid">
      ...
      <div class="buy"><button onclick="openPage(this)">Buy</button></div>
      <div class="amount">Rs799</div></section>
   
    <section class="grid" id="grid2">
    <img src="../images/img2.jpg" alt="">
    <p class="buy"><button onclick="openPage(this)">Buy</button></p>
    <p class="amount">Rs 799</p></section>

    <section class="grid" id="grid3">
    <img src="../images/img4.jpg" alt="">
    <p class="buy"><button onclick="openPage(this)">Buy</button></p>
     <p class="amount">Rs 999</p></section>
...
<script>
  function openPage(clickedElement){
    const amount=clickedElement.nextElementSibling;
    console.log(amount);
